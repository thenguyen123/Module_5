  ...
  ngOnInit(): void {
    ...
    this.customerService.findById(this.id).subscribe(param => {
      ...
      this.customerForm = new FormGroup({
        ...
        birthday: new FormControl(this.customer.dayOfBrith, [Validators.required]),
        ...
        phone: new FormControl(this.customer.phoneNumber, [Validators.required, Validators.pattern('^(090\\d{7}|091\\d{7}|\\(84\\)\\+91\\d{7}|\\(84\\)\\+90\\d{7})$')]),
